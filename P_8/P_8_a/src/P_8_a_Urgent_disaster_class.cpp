...
Urgent_disaster_class::Urgent_disaster_class(locations l, const std::string& descr) : location{l}, Disaster_class{descr} {}

Urgent_disaster_class* Urgent_disaster_class::clone(void) {
